...
export const Home = ({toggle, darkMode}) => {
  ...
  return (
    <div className='px-6 py-4 flex flex-col gap-y-5 top-20 bg-gray-50 dark:bg-neutral-700 dark:text-neutral-300'>
      ...
      <div className='flex gap-x-5 content-center ' >
        ...
        {/* First BTN */}
        <div className={`cursor-pointer flex  gap-x-3 justify-center content-center border border-solid bg-white dark:bg-neutral-900 rounded-lg p-2 px-4 
        ...
        {/* Second BTN */}
        <div className={`cursor-pointer flex  gap-x-3 justify-center content-center border border-solid p-2 px-4 bg-white dark:bg-neutral-900 rounded-lg
                          ${active===2 ? "border-[3px] border-black dark:border-white " : "" }`}
          onClick={()=>setActive(2)}
        >
            <FaGithub className='h-6 self-center dark:text-white'/>
